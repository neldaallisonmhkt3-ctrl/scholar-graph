...
- 节点数量控制在10-30个之间
- 【关键】关系不能只形成以一个核心节点为中心的放射状结构！同级知识点之间也要建立关联，例如：
  · 并列的概念之间用"对比"关系连接
  · 同属一个大概念下的子知识点之间也可以有"依赖于"或"推导出"的关系
  · 一个知识点可以同时是多个其他知识点的"前置知识"
  · 确保大多数节点至少有2条边，且图中存在丰富的交叉连接
  · 避免出现"一棵树"的形状，要让图谱更像"网状"结构
